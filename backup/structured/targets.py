...
class TargetMixture(object):
    ...
    def solve1(self, input, eta):
        ...
        res = minimize(targetFunction, x0, method='L-BFGS-B', options={'gtol': 1e-2, 'disp': False})
        if np.random.uniform(0,1) < 1/10000:
...
class NFarget(object):
    # We assume alpha is 1 and dimension must be at least 2
