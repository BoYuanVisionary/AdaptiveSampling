...
if __name__ == "__main__":
    def main(seed,dimension,large_condition):
        ...
        # Define a funnel distribution
        t = targets.NFarget(dimension = dimension,prob = 1)
        ...
        return Xsamples,direction,Xsamples_MALA
    ...
    cProfile.run("samples, direction, _ = main(10,10,True)", sort="cumulative", filename="profile_results")
