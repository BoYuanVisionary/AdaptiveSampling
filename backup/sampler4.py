...
Xsamples,stepSizes = diagnosis(numIter= 100000, initialStep = 100, numSamples = 1, dimension = 5, alpha = 0.5, fixed = False)
diagnosis(numIter= 100000, initialStep = 0.005, numSamples = 1 , dimension = 5, alpha = 0.5, fixed = True)
